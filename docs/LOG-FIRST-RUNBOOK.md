...
> which is canonical, and the decision is D433 — the owner's adoption of
...
**What no step here may do** (D433 §4, D432 §3): show fewer people,
questions or answers than today; change a number a user sees; move a
cadence a user can notice except the two D433 states — a card's count at
