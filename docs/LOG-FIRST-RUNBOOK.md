...
> which is canonical, and the decision is D439 — the owner's adoption of
...
**What no step here may do** (D439 §4, D438 §3): show fewer people,
questions or answers than today; change a number a user sees; move a
cadence a user can notice except the two D439 states — a card's count at
