...
| One cold boot | **+399 reads** — the whole question bank | `V2_QUESTIONS`, 399 docs (84.9 KiB measured at 389; the v18 duel additions add ~2 KiB) |
...
app once pays the full 399 reads for a bank they will barely use.
