...
## D55 · The logic test stops telegraphing its rules: banded families, and every puzzle is on the clock
...
## D56 · Verified logic attempts: D31's deferral reversed — the server holds the key
...
- `logicSubmitV2` takes twelve raw pick indexes (-1 = expired),
  ...
  deadline (12 × 90s + one item of slack — the D55 cap arithmetic,
