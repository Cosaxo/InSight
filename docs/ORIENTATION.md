...
| [`USAGE-REDUCTION.md`](USAGE-REDUCTION.md) | The other budget: the account usage the routine program spends against three subscriptions. What was read (this account in the seven-day warning band a quarter into its window), where the usage goes, and ten levers ranked — nine of which keep every lane's output. Nothing applied; cadence is the owner's | plan |
