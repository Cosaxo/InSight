...
| [`VISION-2026-09-02.md`](VISION-2026-09-02.md) | The 2026-09-02 design measured against the tree: one instrument for the three Patterns lenses (the Map redrawn as a ring, the Oracle in the field, the People lens coloured by agreement), a serif voice for every prompt, the split ballot, and four smaller passes. Nothing built; §7 is the build order as worklist lines, §8 the gate per step. Source extracted to `design/standalone-2026-09-02/` — compiled JSX, the README says why | plan |
