...
| `check:taxonomy` | ci | A category is written at every site or not at all (D421) — the feed's palette against its wire list, `CAT_META` against `map-branches.js`, hue distinctness, and the proposal ledger |
