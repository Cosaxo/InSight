...
| [`VISION-2026-09-12.md`](VISION-2026-09-12.md) | The 2026-09-12 design measured against the tree — the current vision (D-2026-09-12a): the owner's `InSight_19` upload, titled *Doxa*. A name in a serif wordmark (the owner's to pick — §1 prices every place the name lives), the friends handshake read as D101's two rows both ways with one push (§2), a *Your friends* overlay and its four doors, the You stop's Map with a trail, Find, a resizable card and coach hints (§3), the person page's two leads (§4), the shell's leave animation and tap slack (§5). §0 the table, §6 the three owner questions (the name, *Groups · 1v1s*, whether anything stays private until you are friends), §7 the build order with what needs no answer first. Nothing built | plan |
