...
| [`PEOPLE-MAP.md`](PEOPLE-MAP.md) | The patterns Map transposed: people placed by their answers. A third lens for the trial tab, phased, with the whole-world variant deferred with its arithmetic | plan |
