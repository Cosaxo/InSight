...
| [`IMPROVEMENT-IDEAS.md`](IMPROVEMENT-IDEAS.md) | One reviewer's list of what to change, remove or add with full creative control, measured against the tree on 2026-09-05 — ship, cold start, the spend, the splits. Plan only; the owner picks from it | plan |
| [`IMPROVEMENT-RUNBOOK.md`](IMPROVEMENT-RUNBOOK.md) | The ideas page's prioritised items as an ordered build list — five rulings up front, then stop the spend, the two legal contradictions and the rules ceiling, submission, the cold start, the aggregate shard, a person on content, the splits — each step with who, size and gate. Plan only | plan |
