...
| [`AXIOM-THEORY.md`](AXIOM-THEORY.md) | The theory layer above the axes: nine recurring lanes on an orphan branch writing each source's perfect form and their combination, and the bridge that is their only path into the product. Live since 2026-08-25 | tree |
