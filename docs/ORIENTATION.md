...
| [`SUPABASE-COMPARISON.md`](SUPABASE-COMPARISON.md) | Supabase measured against this tree rather than in general: what the Firebase surface actually is, which four shapes exist only to work around Firestore, and which three Firebase products have no counterpart. No decision taken | mixed |
