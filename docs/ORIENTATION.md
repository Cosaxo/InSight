...
| [`VISION-2026-08-26.md`](VISION-2026-08-26.md) | The 2026-08-26 design measured against the tree. Anonymous answers and private results (the first amendment D98 would notice), co-funded subscription seats + the read-only catalog window, the Oracle's "working", the Patterns polish and the person overlay's Play together card — two owner decisions gate the big halves, the rest is client work. Source extracted to `design/standalone-2026-08-26/` | plan |
