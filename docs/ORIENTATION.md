...
| `check:duel-sample` | deploy | `content/duel-sample.json` — the fixed slice of the duel bank the JS bundle carries (D433, D284's shape one bank over) — is what its source generates |
