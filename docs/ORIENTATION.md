...
| [`SIGNIN-PLAN.md`](SIGNIN-PLAN.md) | The account wall and its three doors — Google (built), Sign in with Apple and email/password (not built), on the owner's 2026-09-07 decision that the app should require an account. Why D219's condition is not met, what Apple guideline 4.8 binds the moment the wall goes up, the order of work, the three console clicks only the owner can make, and what it costs the release | plan |
