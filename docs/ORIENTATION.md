...
| [`PAID-PLAN.md`](PAID-PLAN.md) | Paid questions with downloadable reports, place-score subscriptions, and cohort pricing by size and demand — the owner's 2026-08-21 ask measured against the standing constraints. Every demand-independent piece is built (D226–D230); pricing and the contract path wait on a buyer | mixed |
