...
| [`AXIOM-THEORY.md`](AXIOM-THEORY.md) | The theory layer above the axes: twelve recurring lanes on an orphan branch — eleven writing each source's perfect form and their combination, one scoring that work every second night (D346) — and the bridge that is their only path into the product. Ran 2026-08-25 → 2026-09-04; **stopped at D364**, corpus and bridge queue kept | tree |
