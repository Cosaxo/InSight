...
| [`VISION-2026-08-24.md`](VISION-2026-08-24.md) | The 2026-08-24 design measured against the tree. The visual passes are built (D273 — Patterns polish, the small pass, the Mirror's "so what" line); the paid door (owner decision pending), the buyer's room and the scorecard split still wait. Source extracted to `design/standalone-2026-08-24/` | mixed |
