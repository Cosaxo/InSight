...
| [`AXIOM-THEORY.md`](AXIOM-THEORY.md) | The theory layer above the axes: twelve recurring lanes on an orphan branch — eleven writing each source's perfect form and their combination, one scoring that work every second night (D342) — and the bridge that is their only path into the product. Live since 2026-08-25 | tree |
