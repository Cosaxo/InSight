...
- [ ] `docs/AXIOM-THEORY.md` opens with "eight recurring Claude lanes" while its roster names nine — done: the sentence matches the roster, and a `check:figures` entry holds it if the count is worth gating — gate: `npm run check:figures`
