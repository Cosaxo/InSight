...
- [x] `[claude-3]` The feed's paper ground and the folded topics — boxed card skins onto the rule ground (the paid card keeps its box), the *all topics* disclosure chip, neutral check chips, the `headHold` guard (`VISION-2026-09-06.md` §4) — gate: `npm run test:unit`, `npm run check:tap-targets` — **built 2026-09-06 (D391)**
