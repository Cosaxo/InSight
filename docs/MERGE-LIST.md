...
<!-- console:ticks  -->
<!-- console:generated 2026-09-11T17:32:40Z -->

## Open

- [ ] **#487** · a session · *what:* Two things, both found by rating the tree against its own claims rather than by working on either. · *how:* Not misconfigured — **absent**, and known only as two lines in `docs/COST-EXPOSURE.md` §7 under *"what this page could not verify from here"*, filed as a **cost** footnote. · CI running (10 pending) · 1 behind main · opened 2026-09-11 · stage **new**
- [ ] **#486** · a session · *what:* Asked for in one sentence — *"go through this app and look for improvments optemzations and clean up and maitance"* — so the subject is the whole tree rather than one surface. · *how:* `docs/DECISIONS.md` D451** is the record. · CI green (10) · 1 behind main · opened 2026-09-11 · stage **new**
- [ ] **#478** · a session · *what:* A 16-lane review of the tree found that the instruments here are better than in most production codebases, and that **every serious gap sits where an instrument cannot reach**. · *how:* These are the eight fixes, one decision record each (`D-2026-09-09a`–`h`). · CI green (10) · 30 behind main · opened 2026-09-10 · stage **new**
