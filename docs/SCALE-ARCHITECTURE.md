...
**Status: design only — ADOPTED 2026-09-09 (D440's amendment; *"that sound like a good direction lets do that"*, the same evening), phase A built that night (`LOG-FIRST-RUNBOOK.md`). Proposed that afternoon on the owner's word —
