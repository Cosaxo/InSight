...
## 10 · The paid-question review — chartered 2026-09-11 (D454), NOT created
...
| | |
| --- | --- |
| Schedule | hourly is the shape the buyer's wait is written against (`web/ask.html`'s held copy promises no cadence, deliberately — D454 kept it to *"come back to this address"*) |
...
than approving it (D454 — the line that used to approve is the most
