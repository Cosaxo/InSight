...
| **D98** | [Answers are public — the privacy model is retired, not paused](DECISIONS.md#d98--answers-are-public--the-privacy-model-is-retired-not-paused) | D367 (+76) | 9129 |
...
| **D161** | [The feed goes unbounded, and the Mirror gets a corpus of its own](DECISIONS.md#d161--the-feed-goes-unbounded-and-the-mirror-gets-a-corpus-of-its-own) | D381 (+22) | 15951 |
...
| **D163** | [The app learns what you are into, and the model never leaves the phone](DECISIONS.md#d163--the-app-learns-what-you-are-into-and-the-model-never-leaves-the-phone) | D383 (+13) | 16142 |
...
| **D197** | [The feed gets real ads, and they are not sponsored questions](DECISIONS.md#d197--the-feed-gets-real-ads-and-they-are-not-sponsored-questions) | D381 (+9) | 20302 |
...
| **D316** | [Serving becomes selection: pages instead of the whole bank, and the order inherits the caps' job](DECISIONS.md#d316--serving-becomes-selection-pages-instead-of-the-whole-bank-and-the-order-inherits-the-caps-job) | D382 (+8) | 32071 |
...
| **D320** | [Learn leaves the boot fetch: the first paged surface](DECISIONS.md#d320--learn-leaves-the-boot-fetch-the-first-paged-surface) | D382 (+3) | 32362 |
| **D321** | [The feed tail leaves the boot fetch, and the whole-bank install is over](DECISIONS.md#d321--the-feed-tail-leaves-the-boot-fetch-and-the-whole-bank-install-is-over) | D382 (+2) | 32420 |
...
| **D334** | [The product is the connections, and a privacy constraint is an ask rather than a stop](DECISIONS.md#d334--the-product-is-the-connections-and-a-privacy-constraint-is-an-ask-rather-than-a-stop) | D369 (+4) | 33878 |
...
| **D354** | [The store leaves the bridge, and the sweep behind it takes the coupling ratchet 234 → 32](DECISIONS.md#d354--the-store-leaves-the-bridge-and-the-sweep-behind-it-takes-the-coupling-ratchet-234--32) | D381 (+4) | 36532 |
...
| **D356** | [First paint comes off the device: the warm boot, and `ready` splits from `attached`](DECISIONS.md#d356--first-paint-comes-off-the-device-the-warm-boot-and-ready-splits-from-attached) | D382 (+1) | 36710 |
...
| **D368** | [Shape A adopted: the paid door leaves the app, and buying moves to the web](DECISIONS.md#d368--shape-a-adopted-the-paid-door-leaves-the-app-and-buying-moves-to-the-web) | D369 | 38656 |
...
| **D381** | [Question content is not first-paint bytes, and a gate says so](DECISIONS.md#d381--question-content-is-not-first-paint-bytes-and-a-gate-says-so) | D382 | 39011 |
| **D382** | [The daily pages: a published length, seven documents, and the density it rests on](DECISIONS.md#d382--the-daily-pages-a-published-length-seven-documents-and-the-density-it-rests-on) | D383 | 39090 |
| **D383** | [The Scores pool pages too: ids in the shape document, documents by the page](DECISIONS.md#d383--the-scores-pool-pages-too-ids-in-the-shape-document-documents-by-the-page) | — | 39176 |
