...
"which decision governs this" is 400 lines instead of
40,429. Do not hand-edit; `npm run check:docs` fails when this
...
| **D197** | [The feed gets real ads, and they are not sponsored questions](DECISIONS.md#d197--the-feed-gets-real-ads-and-they-are-not-sponsored-questions) | D381 (+12) | 20302 |
...
| **D381** | [Question content is not first-paint bytes, and a gate says so](DECISIONS.md#d381--question-content-is-not-first-paint-bytes-and-a-gate-says-so) | D382 | 40193 |
| **D382** | [The daily pages: a published length, seven documents, and the density it rests on](DECISIONS.md#d382--the-daily-pages-a-published-length-seven-documents-and-the-density-it-rests-on) | D383 | 40272 |
| **D383** | [The Scores pool pages too: ids in the shape document, documents by the page](DECISIONS.md#d383--the-scores-pool-pages-too-ids-in-the-shape-document-documents-by-the-page) | — | 40358 |
