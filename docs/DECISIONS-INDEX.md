...
40,927. Do not hand-edit; `npm run check:docs` fails when this
...
| **D25** | [The world feed loads after first paint; the rest of the split waits](DECISIONS.md#d25--the-world-feed-loads-after-first-paint-the-rest-of-the-split-waits) | D388 (+9) | 2080 |
...
| **D354** | [The store leaves the bridge, and the sweep behind it takes the coupling ratchet 234 → 32](DECISIONS.md#d354--the-store-leaves-the-bridge-and-the-sweep-behind-it-takes-the-coupling-ratchet-234--32) | D388 (+5) | 36532 |
...
| **D382** | [Question content is not first-paint bytes, and a gate says so](DECISIONS.md#d382--question-content-is-not-first-paint-bytes-and-a-gate-says-so) | D388 (+2) | 40409 |
...
| **D388** | [The other two lanes leave first paint, and three stale notes are why they were still there](DECISIONS.md#d388--the-other-two-lanes-leave-first-paint-and-three-stale-notes-are-why-they-were-still-there) | — | 40841 |
