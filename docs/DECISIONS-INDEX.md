...
27,658. Do not hand-edit; `npm run check:docs` fails when this
...
| **D28** | [Fake accounts: prevention stays partial, the record becomes correctable](DECISIONS.md#d28--fake-accounts-prevention-stays-partial-the-record-becomes-correctable) | D277 (+11) | 2283 |
...
| **D168** | [Born or built is refused: the app does not assert facts it cannot recompute](DECISIONS.md#d168--born-or-built-is-refused-the-app-does-not-assert-facts-it-cannot-recompute) | D277 (+1) | 16533 |
...
| **D212** | [Questions ship without waiting for a person](DECISIONS.md#d212--questions-ship-without-waiting-for-a-person) | D277 | 21995 |
...
| **D254** | [The axis bands ship, in the app's own vocabulary](DECISIONS.md#d254--the-axis-bands-ship-in-the-apps-own-vocabulary) | D277 (+1) | 25662 |
...
| **D276** | [The suite audited itself: what stayed green while being wrong](DECISIONS.md#d276--the-suite-audited-itself-what-stayed-green-while-being-wrong) | D277 | 27450 |
| **D277** | [Axes, Axiom Theory, and the program between them](DECISIONS.md#d277--axes-axiom-theory-and-the-program-between-them) | — | 27593 |
