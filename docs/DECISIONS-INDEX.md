...
35,239. Do not hand-edit; `npm run check:docs` fails when this
...
| **D3** | [Anonymous-first auth with account linking](DECISIONS.md#d3--anonymous-first-auth-with-account-linking) | D352 (+23) | 97 |
...
| **D352** | [First paint comes off the device: the warm boot, and `ready` splits from `attached`](DECISIONS.md#d352--first-paint-comes-off-the-device-the-warm-boot-and-ready-splits-from-attached) | D353 | 34790 |
| **D353** | [An answer the server has not acknowledged survives the relaunch](DECISIONS.md#d353--an-answer-the-server-has-not-acknowledged-survives-the-relaunch) | — | 35058 |
