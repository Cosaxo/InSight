...
40,916. Do not hand-edit; `npm run check:docs` fails when this
...
| **D407** | [Three behaviour signals get a reader: whether the Mirror is READ, not only answered into](DECISIONS.md#d407--three-behaviour-signals-get-a-reader-whether-the-mirror-is-read-not-only-answered-into) | — | 40840 |
