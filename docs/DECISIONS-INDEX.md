...
32,179. Do not hand-edit; `npm run check:docs` fails when this
...
| **D3** | [Anonymous-first auth with account linking](DECISIONS.md#d3--anonymous-first-auth-with-account-linking) | D276 (+20) | 97 |
...
| **D8** | [Per-anchor breakdowns are built; collecting the anchors is not](DECISIONS.md#d8--per-anchor-breakdowns-are-built-collecting-the-anchors-is-not) | D304 (+34) | 449 |
...
| **D33** | [The farm gets eyes and a faster clock: the scorecard, and daily runs](DECISIONS.md#d33--the-farm-gets-eyes-and-a-faster-clock-the-scorecard-and-daily-runs) | D313 (+11) | 2807 |
...
| **D40** | [Duels get a content lane and a question-level signal](DECISIONS.md#d40--duels-get-a-content-lane-and-a-question-level-signal) | D313 (+10) | 3851 |
...
| **D82** | [Near by radius (~500 m) — asked for, priced, and deferred](DECISIONS.md#d82--near-by-radius-500-m--asked-for-priced-and-deferred) | D313 (+2) | 8003 |
...
| **D86** | [Answers become editable — D5 amended, not repealed](DECISIONS.md#d86--answers-become-editable--d5-amended-not-repealed) | D319 (+22) | 8349 |
...
| **D96** | [A live build advertises no demo communities or empty leaves — and every bank subject runs always-on](DECISIONS.md#d96--a-live-build-advertises-no-demo-communities-or-empty-leaves--and-every-bank-subject-runs-always-on) | D319 (+4) | 8948 |
...
| **D98** | [Answers are public — the privacy model is retired, not paused](DECISIONS.md#d98--answers-are-public--the-privacy-model-is-retired-not-paused) | D319 (+63) | 9129 |
...
| **D161** | [The feed goes unbounded, and the Mirror gets a corpus of its own](DECISIONS.md#d161--the-feed-goes-unbounded-and-the-mirror-gets-a-corpus-of-its-own) | D318 (+20) | 15921 |
...
| **D163** | [The app learns what you are into, and the model never leaves the phone](DECISIONS.md#d163--the-app-learns-what-you-are-into-and-the-model-never-leaves-the-phone) | D319 (+8) | 16112 |
| **D164** | [The revenue paths, re-derived against an unbounded feed](DECISIONS.md#d164--the-revenue-paths-re-derived-against-an-unbounded-feed) | D314 (+2) | 16168 |
...
| **D183** | [The disclosures leave the app, and get a gate on the way out](DECISIONS.md#d183--the-disclosures-leave-the-app-and-get-a-gate-on-the-way-out) | D295 (+7) | 18249 |
...
| **D197** | [The feed gets real ads, and they are not sponsored questions](DECISIONS.md#d197--the-feed-gets-real-ads-and-they-are-not-sponsored-questions) | D319 (+5) | 20254 |
...
| **D213** | [Every servable type generates, and the feed goes daily](DECISIONS.md#d213--every-servable-type-generates-and-the-feed-goes-daily) | D316 | 22069 |
...
| **D228** | [The buyer model: three dims, nameless if wanted, and the lens waits](DECISIONS.md#d228--the-buyer-model-three-dims-nameless-if-wanted-and-the-lens-waits) | D288 (+2) | 23138 |
...
| **D258** | [Two shipped surfaces the bank never fetched](DECISIONS.md#d258--two-shipped-surfaces-the-bank-never-fetched) | D290 | 25948 |
...
| **D265** | [Patterns comes back on the data, not on a flag](DECISIONS.md#d265--patterns-comes-back-on-the-data-not-on-a-flag) | D319 (+2) | 26496 |
...
| **D271** | [Per-question attention, aggregate-only — the R4 gate](DECISIONS.md#d271--per-question-attention-aggregate-only--the-r4-gate) | D313 | 27145 |
...
| **D283** | [Every field is followed, and the follow list gets a way out](DECISIONS.md#d283--every-field-is-followed-and-the-follow-list-gets-a-way-out) | D318 (+2) | 28575 |
| **D284** | [The learn bank leaves the JavaScript](DECISIONS.md#d284--the-learn-bank-leaves-the-javascript) | D313 (+1) | 28679 |
| **D285** | [The seed's whitelist, held to the generator — after the third time](DECISIONS.md#d285--the-seeds-whitelist-held-to-the-generator--after-the-third-time) | — | 28835 |
...
| **D288** | [The board retires, the crowds get honest labels, and the paid mechanism builds ahead of demand](DECISIONS.md#d288--the-board-retires-the-crowds-get-honest-labels-and-the-paid-mechanism-builds-ahead-of-demand) | D289 | 29075 |
...
| **D312** | [The answer-state caches leave the quota: the instrument, then the IndexedDB rows](DECISIONS.md#d312--the-answer-state-caches-leave-the-quota-the-instrument-then-the-indexeddb-rows) | D315 | 31586 |
| **D313** | [Serving becomes selection: pages instead of the whole bank, and the order inherits the caps' job](DECISIONS.md#d313--serving-becomes-selection-pages-instead-of-the-whole-bank-and-the-order-inherits-the-caps-job) | D318 (+4) | 31716 |
| **D314** | [The taste model moves to the server, because selection cannot be personal from inside a page](DECISIONS.md#d314--the-taste-model-moves-to-the-server-because-selection-cannot-be-personal-from-inside-a-page) | D319 (+2) | 31829 |
| **D315** | [The bank cache leaves the small box](DECISIONS.md#d315--the-bank-cache-leaves-the-small-box) | D318 | 31908 |
|  | ↳ *amendment 2026-08-26* — [The merge converged on D312's store, the same day](DECISIONS.md#d315-amendment-2026-08-26--the-merge-converged-on-d312s-store-the-same-day) | — | 31945 |
| **D316** | [The serving order publishes nightly](DECISIONS.md#d316--the-serving-order-publishes-nightly) | D318 (+1) | 31961 |
| **D317** | [Learn leaves the boot fetch: the first paged surface](DECISIONS.md#d317--learn-leaves-the-boot-fetch-the-first-paged-surface) | D318 | 32007 |
| **D318** | [The feed tail leaves the boot fetch, and the whole-bank install is over](DECISIONS.md#d318--the-feed-tail-leaves-the-boot-fetch-and-the-whole-bank-install-is-over) | — | 32065 |
| **D319** | [The profile is real: feed answers counted by topic, and pages sized by them](DECISIONS.md#d319--the-profile-is-real-feed-answers-counted-by-topic-and-pages-sized-by-them) | — | 32114 |
