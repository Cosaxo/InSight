...
| Duel reveals | **indexed** | `roundDeadlineAt` lets the scan ask "which groups' open round is due" instead of reading every group (ROUNDS-PLAN / D420; it was `pendingDays` under the day) |
