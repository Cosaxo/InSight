...
- **The catalog lane's blocked half** (decided, D14/D15 — narrowed at
  D232, again at D265, 2026-08-23): the pick surface is LIVE for every
  ...
  run committed `public/films.txt` (D265). What remains is one domain
  ...
  seats Chaplin 3rd. D265 carries the arithmetic and the three routes
  out; **D266 took one** — a measured mechanical rule plus a reviewed
