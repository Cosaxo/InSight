...
**Status: mixed — steps 1 to 5 (§3–§7) are BUILT at D451–D455 over 2026-09-09 and 2026-09-10; step 0 (§2) is the owner's console read and is not a build.** Written
...
## 3 · Step 1 — a cohort prior for the Oracle, on the device — **BUILT (D451, 2026-09-09)**
...
for the viewer's own dot. D451 has the reasoning.
...
## 4 · Step 2 — anchors as items in the fit — **BUILT (D452, 2026-09-09)**
...
device the anchors are evidence under the WORLD centre only, so D451's
...
## 5 · Step 3 — catalogue picks — **BUILT (D453, 2026-09-09)**
...
SERVED as core is the owner-list row D453 filed. Then the deviations:
...
again 2026-09-10 (D456): the pick cards were tail on PURPOSE — the
generator's own comment said an entity answer has no option share for
a cohort fold — not unclassified as D453 read it; on the owner's word
...
## 6 · Step 4 — calibration and the meter — **BUILT (D454, 2026-09-10)**
...
## 7 · Step 5 — the walls — **BUILT (D455, 2026-09-10)**
...
- **Changing the corpus rule.** D161 stands for the Mirror: core only.
  The fit's own clause had one recorded exception at D453 — the
  catalogue picks, then tail by the flag — which closed at D456 when the
