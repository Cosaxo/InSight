...
morning; §5 is the build order, approved by the owner the same day (D445)
...
> The owner chose *live* (D445 amendment); the trigger writes the entry in
...
- **The nightly pass holds the day — the fifth, found on the other
  ...
  holds on disk — and D446 puts the direction to the owner.
