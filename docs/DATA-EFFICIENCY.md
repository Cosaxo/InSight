...
morning; §5 is the build order, approved by the owner the same day (D446)
...
> The owner chose *live* (D446 amendment); the trigger writes the entry in
...
- **The nightly pass holds the day — the fifth, found on the other
  ...
  holds on disk — and D447 puts the direction to the owner.
