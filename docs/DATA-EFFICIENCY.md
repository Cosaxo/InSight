...
morning; §5 is the build order, approved by the owner the same day (D432)
...
> The owner chose *live* (D432 amendment); the trigger writes the entry in
...
- **The nightly pass holds the day — the fifth, found on the other
  ...
  holds on disk — and D433 puts the direction to the owner.
