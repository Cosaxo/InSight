...
> is canonical, and the decision is D445 — the owner's approval of every
...
priced at about 6 % of what the map saves — and D445 records that the
word confirming it is still the owner's to give.

**What no step here may do** (D445 §3): show fewer people, questions or
...
- [x] **0.1 The decision.** D445 in `DECISIONS.md`: what is approved, the
...
- [x] **1.4 Foreground refresh reads today only. DONE 2026-09-08** —
      ...
      unchanged. The one cadence item in this file — D445 names it, and
...
- [x] **2.1 The ledger entry carries the name and the scores. DONE
      ...
      (D445 §2). The trigger reads nothing unless the stamp changed, then
...
live for the answer map"* — the D445 amendment). Two things moved against
...
## Phase 5 — the write path at scale · **L** · **direction under the owner's decision at D446**
...
> word they stand. **The word came the same evening (D446's amendment):
...
- ~~**The log-first direction** (D446, `SCALE-ARCHITECTURE.md`): whether
  ...
  (D446's amendment); the clicks that remain are `LOG-FIRST-RUNBOOK.md`'s.
- **The word "live"** for Phase 3 — given 2026-09-08 (the D445
