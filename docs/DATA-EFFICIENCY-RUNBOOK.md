...
> is canonical, and the decision is D440 — the owner's approval of every
...
priced at about 6 % of what the map saves — and D440 records that the
word confirming it is still the owner's to give.

**What no step here may do** (D440 §3): show fewer people, questions or
...
- [x] **0.1 The decision.** D440 in `DECISIONS.md`: what is approved, the
...
- [x] **1.4 Foreground refresh reads today only. DONE 2026-09-08** —
      ...
      unchanged. The one cadence item in this file — D440 names it, and
...
- [x] **2.1 The ledger entry carries the name and the scores. DONE
      ...
      (D440 §2). The trigger reads nothing unless the stamp changed, then
...
live for the answer map"* — the D440 amendment). Two things moved against
...
## Phase 5 — the write path at scale · **L** · **direction under the owner's decision at D441**
...
> word they stand. **The word came the same evening (D441's amendment):
...
- ~~**The log-first direction** (D441, `SCALE-ARCHITECTURE.md`): whether
  ...
  (D441's amendment); the clicks that remain are `LOG-FIRST-RUNBOOK.md`'s.
- **The word "live"** for Phase 3 — given 2026-09-08 (the D440
