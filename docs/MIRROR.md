...
| **City** | your city: answers, lenses, and the kindred constellation | `v2_question_aggs.by.city[your city]` — and, for a question whose hot map is at its 24-bucket cap without your city, your own shard of `v2_agg_overflow/{qid}-{s}` merged in (D388, `LIVE.loadOverflow`); kindred from voter lists + `testResults` (D112) | yes since D111/D112 — its own stop again |
| **Country** | everyone in your country, plus its cities placed by score likeness | `v2_question_aggs.by.country[…]`, with your country's tail shard merged in where the hot map is at its cap (D388); city profiles folded from `by.city` (D112) — the hot 24 only | yes |
