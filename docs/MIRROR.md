...
| a live card's who-voted sheet, cohort-first (D124) | `src/v2/ui/LiveBreakdownPanel.tsx` |
| bucket key → the name a reader sees (D124) | `src/v2/ui/cohortLabels.ts` |
