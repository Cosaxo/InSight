...
| a live card's who-voted sheet, cohort-first (D122) | `src/v2/ui/LiveBreakdownPanel.tsx` |
| bucket key → the name a reader sees (D122) | `src/v2/ui/cohortLabels.ts` |
