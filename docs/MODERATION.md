...
Takes are free-text comments, in a circle or at world scale, **named at both since D94**.
...
Takes are named and world-visible (D94). The moderation run sees **flagged takes
