...
- `src/v2/test/mount-app.jsx` is the harness, and **nine** suites mount
  ...
  Circle and 1v1 modes, the demo Mirror's stops past World, and the You
  stop on a live build whose boot never attached, which is the one stop
  that wore no Preview tag. (The sixth
