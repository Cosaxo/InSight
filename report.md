# Device screens — 2026-09-06T21:43:08Z

Mode: **DEMO** · source: android:emulator-5554 · 11 screens across 1 profile(s) · **10 hard** / 0 soft finding(s)

Target: sdk_gphone64_x86_64 · com.cosaxo.insight

## Findings — read these first

- **[hard] android-sdk-gphone64-x86-64 / daily-reveal-NO-APP** — drive failed: the app did not open for this scene — locator.waitFor: Target page, context or browser has been closed
Call log:
  - waiting for getByRole('button', { name: /^mirror$/i }).first() to be visible
 → `(none)`
