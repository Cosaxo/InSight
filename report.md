# Device screens — 2026-09-06T22:13:03Z

Mode: **DEMO** · source: android:emulator-5554 · 22 screens across 1 profile(s) · **0 hard** / 4 soft finding(s) · 1 skipped
...
- **[soft] android-sdk-gphone64-x86-64 / profile** — text wider than its box: <text> "Trail running" by 19px (overflow-x: visible, below the fold) → `android-sdk-gphone64-x86-64/20-profile.png`
- **[soft] android-sdk-gphone64-x86-64 / profile-tests** — unchanged: the screen is pixel-identical to the previous capture in this scene — the tap may have done nothing → `android-sdk-gphone64-x86-64/21-profile-tests.png`
- **[soft] android-sdk-gphone64-x86-64 / profile-tests** — text wider than its box: <text> "Trail running" by 19px (overflow-x: visible, below the fold) → `android-sdk-gphone64-x86-64/21-profile-tests.png`

## Screens

### sdk_gphone64_x86_64 (412×891 @2.625)
...
| 20 | profile | `android-sdk-gphone64-x86-64/20-profile.png` | △ text wider than its box |
| 21 | profile-tests | `android-sdk-gphone64-x86-64/21-profile-tests.png` | △ unchanged, △ text wider than its box |
