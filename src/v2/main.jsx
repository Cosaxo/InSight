...
// The root, imported (D353's sweep) — spec-index above has already
...
initLive().finally(() => {
  ...
  // The Mirror (D354) — the second tab, one tap from first paint, so this
  ...
  //
  // Started AFTER loadWorldFeed rather than alongside it — and since D354
