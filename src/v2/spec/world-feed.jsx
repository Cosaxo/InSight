...
// since D353. The `window.LIVE &&` existence guards it took with it were
...
// D353's sweep: the feed's own group members and the eager passive tag as
...
class WorldFeed extends React.Component {
  ...
  // (there are none left since D353). `return PICKS` for the same reason
