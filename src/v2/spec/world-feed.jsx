...
// The live who-voted sheet, cohort-first (D122) — it owns the cohort
...
// hand-kept copy of BREAKDOWN_DIMS (functions/src/pure.ts). D122 moved the
...
class WorldFeed extends React.Component {
  ...
  componentWillUnmount() {
    // The learn-agg prefetch (D122) resolves after an await, so it can land
  ...
  knowQs(n, cats) {
    ...
    if (this._kqSig !== sig || !this._kq) {
      ...
      // Warm the crowd splits for the whole plan, here (D122). This is the
  ...
  renderKnow(q, T, big) {
    ...
    // The split and its provenance, read TOGETHER at render (D122).
    //
  ...
  // The viewer's own option index on a live card, or -1 (D122). Local
  ...
  // The live dial breakdown, cohort-first (D122). The panel above owns the
  ...
  // The live field breakdown, cohort-first (D122) — the same reversal the
  ...
  renderStats(q, T) {
    ...
    // The whole live sheet, cohort-first (D122). One component owns the
