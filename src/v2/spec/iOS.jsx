/* eslint-disable */
// ported from design/spec-modules/iOS.jsx — do not hand-edit load order assumptions
  ...
  return (
    <div style={{
      ...
      <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
        ...
        <div className="ios-screen-scroll" style={{ flex: 1, overflow: 'auto' }}>{children}</div>
...
;globalThis.IOSListRow = typeof IOSListRow === 'undefined' ? globalThis.IOSListRow : IOSListRow;
;globalThis.IOSList = typeof IOSList === 'undefined' ? globalThis.IOSList : IOSList;
