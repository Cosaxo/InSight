...
// The update-required blocker (D240) — its own component because
...
function App() {
  ...
  useEffect(() => {
    ...
    // Registered (D238) rather than published: these are closures over this
  ...
  useEffect(() => {
    ...
    // D238: registered, not published. `openProfileTab` joins them here —
