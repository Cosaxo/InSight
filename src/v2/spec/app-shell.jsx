...
// The update-required blocker (D241) — its own component because
...
function App() {
  ...
  useEffect(() => {
    ...
    // Registered (D239) rather than published: these are closures over this
  ...
  useEffect(() => {
    ...
    // D239: registered, not published. `openProfileTab` joins them here —
