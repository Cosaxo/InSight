...
// The update-required blocker (D244) — its own component because
...
function App() {
  ...
  useEffect(() => {
    ...
    // Registered (D242) rather than published: these are closures over this
  ...
  useEffect(() => {
    ...
    // D242: registered, not published. `openProfileTab` joins them here —
