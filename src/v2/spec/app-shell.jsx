...
// The Mirror chunk's handoff (D354) — see MirrorSlot below.
import { peekMirror, rememberMirror } from '../data/mirrorChunk';
import LIVE from '../data/live';
// D353's sweep: the shell's own eager neighbours as imports — the daily
...
// The Mirror tab, after first paint (D354) — a SLOT rather than a
