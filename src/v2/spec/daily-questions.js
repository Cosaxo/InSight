...
(function () {
  ...
  const Q = [
    ...
    { type: 'binary', prompt: 'Your handwriting: proud of it, or barely legible?', tag: 'The hand', options: ['Proud of it', 'Barely legible'], tone: 'light',
      cat: ['Skills', 'Craft'], alts: [['Story', 'The record'], ['Mind', 'Care']] },
    { type: 'binary', prompt: 'No stake in the game: do you still pick a side?', tag: 'Neutral no more', options: ['Always', 'I just watch'], tone: 'light',
      cat: ['Sport', 'Allegiance'], alts: [['Mind', 'Instinct'], ['Story', 'Drama']] },
    { type: 'binary', prompt: 'The ache the day after exercise: satisfying, or just sore?', tag: 'The ache', options: ['Satisfying', 'Just sore'], tone: 'light',
      cat: ['Body', 'Signals'], alts: [['Mind', 'Reward'], ['Goals', 'Effort']] },
    { type: 'choice', prompt: 'Subtitles on, even when it’s in your language?', tag: 'Captions', options: ['Always on', 'Only foreign languages', 'Only when I can’t hear it', 'Never'], tone: 'light',
      cat: ['Film', 'How you watch'], alts: [['Mind', 'Attention'], ['Skills', 'Listening']] },
    { type: 'binary', prompt: 'Leftovers: better the next day, or a sad echo?', tag: 'Leftovers', options: ['Better the next day', 'A sad echo'], tone: 'light',
      cat: ['Food', 'The next day'], alts: [['Home', 'Thrift'], ['Values', 'Waste']] },
    { type: 'scale', prompt: 'Done beats perfect.', tag: 'The finish', axis: 'ship it', tone: 'blend',
      cat: ['Goals', 'Finishing'], alts: [['Skills', 'Craft'], ['Mind', 'Standards']] },
    { type: 'choice', prompt: 'Collections: about the hunting, or the having?', tag: 'The chase', options: ['The hunting', 'The having', 'The arranging', 'I don’t collect'], tone: 'blend',
