...
// compare-pop.js stood here until D354: IS_COMPARE_POP's only readers are
...
// demographics.js stood here until D354 — DEMOGRAPHICS has one reader,
...
// compare-breakdown.jsx stood here until D354 — the Mirror block below.
...
// lens-defs.js stood here until D354 (the Mirror block below). Its old
...
//
// THE MIRROR'S THIRTEEN left this list at D354 for loadMirrorTab() at the
...
// ui/CityPicker and ui/PickSearch stood here until D353's sweep. Born in
...
// ── the Mirror, after first paint too (D354) ───────────────────────────
//
...
export const loadOverlays = retryable(async () => {
  // The Mirror's family first (D354): three members of this group read
