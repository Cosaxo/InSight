...
// SIDE when their side is known (D149). An argument reads completely
...
function LiveTakesPanel({ gid, qid, options }: {
  ...
  qid: string;
  /**
   * The question's option labels, in the question's own order (D149).
   *
  ...
  // WHERE A SIDE COMES FROM (D149). Not from the take document — `v2_takes`
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 10, width: "100%" }}>
      ...
      {/* Filter by side (D149). The prototype's Takes sheet has led with
