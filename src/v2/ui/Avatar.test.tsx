...
//      was written and is fixed at D243; the case now holds the fix.
...
describe("a photo that will not load", () => {
  ...
  it("retries a NEW token for the same person (D244)", () => {
...
describe("the initials, which are the permanent fallback", () => {
  ...
  it("keeps a whole astral character, first word or last (D243)", () => {
