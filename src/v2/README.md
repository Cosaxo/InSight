...
seven is a deliberate keep (D245), each with its reason recorded beside it
...
**That sentence has now been wrong twice, and D245 is the second
...
the sites. When D245 did, six of the seven turned out to be the SAME case
...
exactly the trade this file refuses. That refusal survives D245 unchanged —
...
prints the current total on every run. The count today is **267 across 37
