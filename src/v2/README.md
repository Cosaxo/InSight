...
seven is a deliberate keep (D240), each with its reason recorded beside it
...
**That sentence has now been wrong twice, and D240 is the second
...
the sites. When D240 did, six of the seven turned out to be the SAME case
...
exactly the trade this file refuses. That refusal survives D240 unchanged —
