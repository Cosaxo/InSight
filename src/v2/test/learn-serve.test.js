...
// ── the pool a fresh install starts with (D283) ──────────────────────
//
...
describe("what a fresh install can reach (D283)", () => {
  ...
  // caller anywhere in the app before D283 — the follow list was one-way.
