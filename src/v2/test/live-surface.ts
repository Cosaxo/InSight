...
export const LIVE_MEMBERS = [
  ...
  // (D395): the Oracle's and the People lens's evidence, read off the
  // banks and the vote mirror so an instrument item counts whether or not
  // its crowd counts are cached.
  "answeredIndex",
  // The nightly voter samples (D396): one document per question in place
  ...
  "loadVoterSample",
  "votersOrSample",
  // The breakdown cap's tail (D399): the viewer's own city or country
