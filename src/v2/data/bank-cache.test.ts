...
vi.mock("../../lib/firebase", () => ({
  ...
  // The API surfaces live.ts binds off the same promise as getDb (D109).
...
vi.mock("firebase/firestore", () => {
  ...
  return {
    ...
    getDocs: (q: { path?: string; cons?: Constraint[] }) => {
      ...
      if (!delta) return Promise.resolve(snapOf(h.bankDocs));
    ...
    // None of these four is exercised here; all four are required since D109,
