...
describe("v2_patterns: the whole collection group is exempt from single-field indexing (D455)", () => {
  ...
  // 40,000 index entries per document, a wall the fit's own growth (D452's
  // anchor rows, D453's pick rows, the second engine's block) walks
