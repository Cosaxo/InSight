...
describe("groupRole", () => {
  ...
  it("has exactly three dimensions — cast is not computed (D204)", () => {
    ...
    // …and the room reading (D381) is an ASIDE, not a fourth dim: the
  ...
  it("reads the room off your guess at where it would land (D381)", () => {
...
// ── the chance scale (D381, ROLES-PLAN §3.2) ────────────────────────────
...
// ── the day's kind (D381, ROLES-PLAN §3.7) ──────────────────────────────
...
describe("projection — guessing your own answer (D381)", () => {
...
// ── rule 4: a type is in the running only when its defining dims are (D381) ──
