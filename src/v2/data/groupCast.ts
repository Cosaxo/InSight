...
// own reveals (D437, the owner's 2026-09-09 design). Pure: no store, no
...
/** A scenario pack, as the seeded question carries it (D434). */
 ...
 * carrying a role (D434). A question the bank cannot name — a device that
