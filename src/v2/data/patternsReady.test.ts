...
describe("the viewer's own count is answers to two-option core questions, and nothing else (D436)", () => {
  // D433 and D434 put the viewer's anchors and catalogue picks into the
