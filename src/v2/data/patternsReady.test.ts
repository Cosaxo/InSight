...
describe("the viewer's own count is answers to two-option core questions, and nothing else (D458)", () => {
  // D455 and D456 put the viewer's anchors and catalogue picks into the
