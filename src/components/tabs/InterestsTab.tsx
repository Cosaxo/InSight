...
// ─── single-interest deep view (voting lists placeholder) ────────
...
function DeepInterestCard({ interestName }: { interestName: string }) {
  return (
    <div className="card" style={{ padding: 14, marginBottom: 14 }}>
      ...
      >
        Community-voted best media, public figures, literature, and
        tips land here. Voting backend ships in the next pass — for
      ...
      >
        {["best media", "best figures", "best literature", "best tips"].map(
          (label) => (
            <div
              key={label}
              style={{
