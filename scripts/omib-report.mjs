...
export function renderScorecard(sc) {
  ...
  L.push("");
  L.push(`Basis: v2_logic_norms/{families, global, adaptive} (public mirrors, exact counts, first counted attempts only) against content/omib.json's published a and b. Bar (${f(sc.bar, 1)} on expected-against-observed) and floor (${sc.minN} attempts): docs/OMIB-PLAN.md §6, D476.`);
  return L.join("\n");
}
