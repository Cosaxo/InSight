...
// D342 around a FLOOR with no ceiling, the feed regulator's shape.
//
...
//
// WHAT BOUNDED THIS LANE UNTIL D342, and why it no longer does. D115 gave it
...
export function learnBudget({ fields, open = 0, demand = null }) {
  ...
  // rather than aspirational. Never zero for stock (D316/D342).
