...
export const CLAIMS = [
  ...
  // D320 — four rows, one per promise, because each is separately
  ...
  // consent rests on.
  ["D320 · the political compass is off until turned on",
    /political compass is off until you turn it on/i],
  ["D320 · nothing political is computed or stored while it is off",
    /nothing political is[\s\S]{0,20}?computed about you and nothing political is[\s\S]{0,20}?stored/i],
  ["D320 · turning it off deletes the compass at once",
    /Turn it off later and the compass is deleted[\s\S]{0,80}?at once/i],
  ["D320 · and the honest limit on what deletion can reach",
