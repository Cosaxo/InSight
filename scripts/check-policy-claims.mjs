...
export const CLAIMS = [
  ...
  // D439 phase A · the answer log is a second copy of every answer, in
  ...
  ["D439 · the answer log exists, in the same project and region, and erasure reaches it within a day",
