...
export const CLAIMS = [
  ...
  ["D308 · the interest profile is counted from feed answers, and the page says the arithmetic",
    /count which topics your feed answers fall into/i],
  ["D308 · the profile is owner-only and never an ad input",
    /interest profile[\s\S]{0,600}?never used for advertising/i],
  // The phase-2 tripwire (D303): folding behaviour in is a FUTURE
  ...
  // force.
  ["D303 · behaviour stays on the device — the profile is answers only",
