...
export function parseNightReviews(text) {
  ...
  for (const line of String(text || "").split("\n")) {
    ...
    // five hours after D365 composed 18 of its 19, and D382 is where the
...
listed in one line without a box instead (D382): its branch stays
...
export function trailRow(state) {
  ...
  return {
    ...
    // made the trail read as eight untouched approvals a day (D382).
