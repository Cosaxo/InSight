...
// D342: what the budget is SPENT on is arithmetic now, not the run's reading
...
// Where a granted budget goes (D342): lane-tiers' unit mode over the
...
if (invokedDirectly) {
  ...
  // D342: where the budget goes, as arithmetic. The scorecard's daily rows
