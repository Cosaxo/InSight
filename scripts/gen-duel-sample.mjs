...
// that the JavaScript bundle carries (D435: learn's treatment, D284, one
// bank over).
//
...
// went in a week: the cast (D434) took the file to 22.8 KiB, and the burst
...
// one split: a `pick` that names a scenario pack is a ROLE VOTE (D434) and
  ...
  if (process.argv.includes("--write")) {
    ...
    if (have === want) {
      ...
      console.error(
        ...
        + "  and it is DERIVED (D435, D284's shape). Editing it by hand makes\n"
