...
// document that carries it, by Firestore's own two ceilings (D455,
...
// profile value the crowd carries (D452), a row per popular catalogue
// pick (D453), the benched engine's block beside the engine's, and a
 ...
 * (D452's budget) and up to 240 pick rows (D453's cap: ten per card,
