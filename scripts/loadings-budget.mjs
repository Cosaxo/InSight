...
// document that carries it, by Firestore's own two ceilings (D436,
...
// profile value the crowd carries (D433), a row per popular catalogue
// pick (D434), the benched engine's block beside the engine's, and a
 ...
 * (D433's budget) and up to 240 pick rows (D434's cap: ten per card,
