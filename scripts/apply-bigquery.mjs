...
// (SCALE-ARCHITECTURE.md phase A, D440): dataset `insight` in europe-west1
...
export function datasetBody(project, dataset = DATASET, location = LOCATION) {
  return {
    ...
    location,
    description: "InSight's answer log (SCALE-ARCHITECTURE.md, D440): one row per ledger entry, the truth every nightly fold is computed from.",
  };
}
