...
Screened `nightb-20260906-lanetest3-screens` @ ddc49d0, run 34059918629 (https://github.com/Cosaxo/InSight/actions/runs/34059918629).

## Environment

- google-services.json: ABSENT (secret empty)
