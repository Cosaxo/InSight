...
Screened `nightb-20260906-lanetest12-screens` @ 65ec883, run 34062798486 (https://github.com/Cosaxo/InSight/actions/runs/34062798486).
...
- maestro screenshots collected: 1
- drive: failure
...
- `maestro-version.txt`
- `maestro.log`
- `maestro/2026-09-06_221253/InSight device screens/commands.json`
- `maestro/2026-09-06_221253/InSight device screens/manifest.json`
- `maestro/2026-09-06_221253/InSight device screens/screen-hierarchy/step-004-assertCondition-(i)mirror.json`
- `maestro/2026-09-06_221253/InSight device screens/screenshots/step-004-assertCondition-(i)mirror.png`
- `maestro/2026-09-06_221253/xctest_runner_2026-09-06_221307.log`
- `step-004-assertCondition-(i)mirror.png`
- `syslog.txt`
