...
Screened `nightb-20260906-lanetest9-screens` @ 3c53603, run 34062166255 (https://github.com/Cosaxo/InSight/actions/runs/34062166255).
...
- emulator: disappeared during the launch on attempt 1
- android: 14 · sdk_gphone64_x86_64 (attempt 2)
- emulator: disappeared during the launch on attempt 2
- process: UNKNOWN — the emulator disappeared during the launch twice; emulator.log is the evidence
- drive: skipped
