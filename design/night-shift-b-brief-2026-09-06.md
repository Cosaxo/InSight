...
up to four times a run, so an Android results ref may carry fewer than the 22 screens and
`environment.txt` says how many boots it took — a screen that did not land is not a finding, and a night that
