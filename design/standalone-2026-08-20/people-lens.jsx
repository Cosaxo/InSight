        ...
        {selP ? (
          <div className="card" style={{ padding: '14px 16px' }}>
            ...
            <div style={{ marginTop: 8, height: 8, borderRadius: 99, background: 'var(--surface-3)', overflow: 'hidden' }}>
              <i style={{ display: 'block', width: Math.round((selP.agree / selP.shared.length) * 100) + '%', height: '100%', borderRadius: 99, background: 'color-mix(in oklab, var(--accent) 34%, var(--surface-2))', transition: 'width .3s var(--ease-out)' }}></i>
            </div>
            {tie ? (
