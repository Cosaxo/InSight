(function () {
  ...
  function AffinityBreakdown({
    ...
    }, dims.map(d => React.createElement("div", {
      key: d.k
  ...
  function receiptLead(rows) {
    const nSame = rows.filter(r => r.same).length,
      nSplit = rows.length - nSame;
    return nSplit === 0 ? `Same answer on all ${rows.length}.` : nSame === 0 ? `Different answers on all ${rows.length}.` : nSplit <= 2 && nSame >= 6 ? `Same answer ${nSame} times out of ${rows.length}. ${nSplit === 1 ? "One" : "Two"} split${nSplit === 1 ? "" : "s"}.` : `Same answer ${nSame} times out of ${rows.length}.`;
  }
  function AnswersPanel({
    ...
    return React.createElement("div", {
      ...
      style: who
    }, " ", "\xB7", " ", firstName, " "), React.createElement("span", {
      style: {
        color: themColor
      }
    }, cur.them)))) : null);
  ...
  function PersonOverlay({
    ...
    const renderMatch = () => {
      if (!window.CompareList) {
        ...
        }, React.createElement(Kicker, null, "What makes the number"), React.createElement("div", {
          style: {
            marginTop: 12
          }
        }, React.createElement(AffinityBreakdown, {
          parts: parts
        })));
      }
      ...
      const interestsSlide = {
        ...
        }, mark(true, "var(--ink)"), "you"), React.createElement("span", {
          style: {
            display: "inline-flex",
            alignItems: "center",
            gap: 6
      ...
      }, React.createElement(Kicker, null, "What makes the number")), React.createElement(window.CompareList, {
        pop: themPop,
        accent: themColor,
        label: who,
        aligns: {
    ...
    const renderTogether = () => {
      ...
      const duoTile = duo && !invited ? playing ? wide("duo", {
        ...
        head: React.createElement(React.Fragment, null, "1v1", pt.duo ? React.createElement(React.Fragment, null, " \xB7 ", typeName(pt.duo)) : null),
      ...
      }, groupTiles) : groupsFallback)), record);
    };
    ...
    }, p.role || p.rel, " \xB7 ", p.age ? `aged ${p.age} · ` : "", p.dist || "in your orbit"), hasRows && React.createElement("div", {
      style: {
        marginTop: 9,
        fontFamily: "var(--sans)",
        fontSize: 13.5,
    ...
    }, receiptLead(rows)), React.createElement("div", {
      style: {
        marginTop: 14,
        display: "flex",
        flexDirection: "column",
    ...
    }, isFriend ? "Friends \u2713" : fStatus === "invited" ? "Invited \xB7 waiting" : "Add friend")), !p.anon && fStatus === "invited" && !confirmRemove && React.createElement("span", {
      style: {
        fontFamily: "var(--sans)",
        fontSize: 11,
        fontWeight: 600,
    ...
    }, "they", "\u2019", "ll see it soon \xB7 tap to cancel"))), React.createElement("div", {
