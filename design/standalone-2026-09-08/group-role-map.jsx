(function () {
  ...
  function RoleSheetCard({
    ...
    }, all.length ? `how ${gname} cast ${person.me ? "you" : person.name}` : `${gname} hasn't cast ${person.me ? "you" : person.name} yet`)), !person.me && window.openPerson && React.createElement("button", {
      className: "press",
