...
(function () {
  ...
  const EX = {
    ...
    group: {
      ...
      dims: {
        ...
        cast:   'The share of scenario crowns the group votes onto you.',
  ...
  function ExplainBtn({ onClick, label }) {
    return (
  ...
  function ExplainSheet({ title, kicker, keyRows, dims, dimKey, onClose }) {
    ...
    return (
      <div className={'wf-scrim' + (closing ? ' is-closing' : '')} onClick={close}>
        <div className="wf-sheet" onClick={(e) => e.stopPropagation()} style={{ maxHeight: '78%' }}>
          ...
          <div className="wf-sheet-body">
            ...
            {keyRows && keyRows.length > 0 && (
              <div style={{ marginTop: 16, paddingTop: 14, borderTop: '0.5px solid var(--rule)', display: 'flex', flexDirection: 'column', gap: 10 }}>
                <span style={{ fontFamily: exSans, fontSize: 10.5, fontWeight: 700, letterSpacing: '0.09em', textTransform: 'uppercase', color: 'var(--ink-3)' }}>How to read it</span>
            ...
            {dims && dims.length > 0 && (
              <div style={{ marginTop: 18, paddingTop: 14, borderTop: '0.5px solid var(--rule)', display: 'flex', flexDirection: 'column', gap: 14 }}>
                <span style={{ fontFamily: exSans, fontSize: 10.5, fontWeight: 700, letterSpacing: '0.09em', textTransform: 'uppercase', color: 'var(--ink-3)' }}>What each one means</span>
                {dims.map((d) => (
                  <div key={d.id}>
  ...
  Object.assign(window, { ExplainBtn, ExplainSheet, EX_GLYPH: exGlyph });
})();
