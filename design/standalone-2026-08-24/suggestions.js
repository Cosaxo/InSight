// suggestions.js — "Ask a question": the paid door's store. No community
// upvotes — every question is bought for a place and a window, reviewed, and
// always marked PAID. Kept here: the user's own asks (localStorage), decline
// copy, and the audience/cadence vocab the composer shares.
(function () {
  ...
  const MINE_DEMO = [
    ...
    { id: 'sgd2', prompt: 'Would you rather never be late or never wait?', type: 'binary', options: ['Never late', 'Never wait'], by: 'You', hue: 35, votes: 1441, status: 'picked', ago: '9d', ran: 'ran for everyone on 9 Aug · 24k answers', cadence: 'once', audience: 'world', demo: true },
