...
const OR_S = 280,
  OR_C = 140;
const orSeat = i => i === 0 ? OR_C - 64 : OR_C + 64;
...
function OracleLens({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    key: curQ.id,
    className: "card ln-card fade-in",
    style: {
    ...
    className: "pt-kick"
  }, "Question ", log.length + 1), rec ? /*#__PURE__*/React.createElement("button", {
    onClick: next,
    style: {
      marginLeft: 'auto',
      border: 'none',
  ...
  }, "sealed")), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: '8px 0 0',
  ...
  }, curQ.prompt), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      minHeight: 0,
      display: 'flex',
    ...
    return /*#__PURE__*/React.createElement("g", {
      ...
      textAnchor: "middle",
      style: {
        fontSize: op.label.length > 10 ? 10 : 11,
        fontWeight: 800,
        letterSpacing: '.1em'
      }
    }, labelOf(i)), !rec && /*#__PURE__*/React.createElement("text", {
      x: cx,
      y: "88",
      fill: "var(--ln-sub)",
      textAnchor: "middle",
    ...
    }, "tap to pick"), mine && /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("rect", {
      x: cx - 16,
      y: "80",
      width: "32",
      height: "16",
  ...
  }, "sealed here")), /*#__PURE__*/React.createElement("g", {
    className: "or2-disc",
    style: {
  ...
  }, rec ? 'ITS GUESS' : 'SEALED GUESS'), /*#__PURE__*/React.createElement("text", {
    x: "0",
    y: dR + 40,
    fill: "var(--ln-sub)",
    textAnchor: "middle",
  ...
  }, sol < 0.15 ? 'nothing to go on' : orSure(conf)))))), !two && !rec && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 6,
  ...
  }, "It guessed your side before you answer, sealed until you tap a half. ", /*#__PURE__*/React.createElement("span", {
    style: {
      color: 'var(--ink-3)'
    }
    ...
    className: "pt-kick"
  }, "Your record ", '\u00b7', " ", log.length, " answer", log.length === 1 ? '' : 's', " ", '\u00b7', " ", /*#__PURE__*/React.createElement("span", {
    style: {
      fontWeight: 600,
      textTransform: 'none',
      letterSpacing: 0
