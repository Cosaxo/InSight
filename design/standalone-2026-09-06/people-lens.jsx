...
(function () {
  ...
  function crowd(popId) {
    ...
    let labeled = 0;
    for (const p of near) {
      if (labeled >= 0) break; // names show on tap only
  ...
  function PeopleLens({
    ...
    }), selP && /*#__PURE__*/React.createElement("text", {
      x: f1(selP.x > C ? selP.x - selP.r - 6 : selP.x + selP.r + 6),
      y: f1(selP.y + 3.5),
      textAnchor: selP.x > C ? 'end' : 'start',
      fill: "var(--ln-ink)",
      stroke: "var(--ln-halo)",
      strokeWidth: "3",
    ...
    }, selP.name), /*#__PURE__*/React.createElement("g", {
      style: {
        opacity: selP ? 0.35 : 1,
        transition: 'opacity .25s ease'
      }
    ...
    }, "you")))), guide && /*#__PURE__*/React.createElement("div", {
    ...
    }), "mostly disagrees"), /*#__PURE__*/React.createElement("span", null, "bigger dot = more answers in common"), /*#__PURE__*/React.createElement("span", null, "tap anyone to see what you share"), /*#__PURE__*/React.createElement("span", null, placed.length, " people ", '\u00b7', " everyone who answered at least ", minShared, " of your ", st.answered, " questions")), /*#__PURE__*/React.createElement("div", {
      className: "ln-list",
      role: "list",
    ...
    }, "Most like you"), near.map(p => {
      const same = tieFor(p, popId);
      return /*#__PURE__*/React.createElement("button", {
        key: p.id,
        role: "listitem",
        className: 'ln-row' + (sel === p.id ? ' is-on' : ''),
        onClick: () => pick(p)
      }, /*#__PURE__*/React.createElement("span", {
        className: "ln-row-av",
        style: {
          background: ag[stepOf(p)]
        }
      }, p.name[0]), /*#__PURE__*/React.createElement("span", {
        className: "ln-row-body"
      }, /*#__PURE__*/React.createElement("span", {
        className: "ln-row-top"
      }, /*#__PURE__*/React.createElement("span", {
        className: "ln-row-name"
      }, p.name), /*#__PURE__*/React.createElement("span", {
        className: "ln-row-sub"
      }, "agrees ", p.agree, " of ", p.shared.length)), /*#__PURE__*/React.createElement("span", {
        className: "ln-row-q"
      }, same ? 'Both said ' + same.label : 'You split on everything you share')));
    ...
    }, "You split on everything you share.")) : null);
  }
