(function () {
  const BR = window.BRAND_NAME || function () {
    try {
      return {
        insight: "inSight",
        endoxa: "Endoxa"
      }[localStorage.getItem("insight.brand.v2")] || "Doxa";
    } catch (e) {
      return "Doxa";
    }
  }();
  ...
  const D = {
    ...
    groups: {
      ...
      count: "138",
      countLabel: "members across 5 circles",
      medianAge: 39,
      youBand: 2,
