...
// is what the deadline does a day later (the owner's rule, 2026-09-08).
{
  ...
  // …and nothing in a group is called (D432): a group answer carries no
  // `guessIdx` — the rules refuse one — and the reveal below publishes the
  // vote alone.
  await expectDenied("a group answer with a call on the room is refused (D432)", () =>
  ...
  ok("a group reveal carries the member's vote and no call (D432), for whoever played");
