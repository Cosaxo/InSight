...
// 7j · the cap's tail (D388), through the real trigger. Twenty-five more
...
// merge-increments land in the emulator, and hot ∪ tail is exact.
{
  ...
  // meets D388): the dry run reports the capped dimension and the shards
  ...
  ok("D290 × D388: the rebuild reproduces the tail's shard count from the answers");
}
