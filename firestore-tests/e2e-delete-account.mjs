...
// The interest profile (D303/D308): under the account's own subtree, so
...
for (const [path, label] of [
  ...
  [`v2_users/${uid}/taste/profile`, "their interest profile (D303/D308) — the page promises this by name"],
