// patternsAls.ts — the candidate engine (D383): the shipped MODEL with a
...
// a log shaped like the app's own (docs/ALGORITHM-REFLECTION.md §1, D382)
...
// same marginal-only baseline (D382). It replaces `q` only after
...
/** Widened eligibility (D383/§3): option-shaped, and core — the daily
