...
describe("runBankRank", () => {
  ...
  describe("dailyShape (D382)", () => {
    ...
    it("collects the Scores pool per scope, in seq order, active only (D383)", () => {
      const shape = dailyShape([
    ...
    it("the shipped bank's pool matches the lens's own predicate", () => {
      ...
      // — the number D382 left as the linear term this record removes.
